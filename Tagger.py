...
async def start(event):
  await event.reply("**👋 **Salam** \n\n**💬 Mən sizin qurupunuzda istifadəçiləri çağırmağınız üçün yaradılmış çox funksiyanal botam**\n\n**✅ Botun istifadə qaydasını öyrənmək üçün**\n\n/help əmrindən istifadə edin**",
            buttons=(
		      ...
		      [Button.url('➕ Məni Qurupa əlavə et ➕', 'http://t.me/LacosteTaggerBot?startgroup=a')],
                      [Button.url('Dəstək Qurupu 👨‍💻', 'https://t.me/LacosteSup')],
                      [Button.url('Rəsmi Kanal 🔖', 'https://t.me/LacosteProject')],
                      [Button.url('Lacoste MMC 🔖', 'https://t.me/LacosteProject')],
		      [Button.url('Owner 👨🏻‍💻', 'https://t.me/Axhmedov')] 
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**@LacostetaggerBot Butonları 🤖**\n\n**/sehidler - ŞƏHİDLƏRİMİZİN ADLARI İLI ÇAĞIRAR\n**/cancel - botu dayandırar**\n**/tag <səbəb> - 5-li tag edər**\n**/etag <səbəb> - Emoji ilə tag edərr**\n**/mtag <səbəb> - mafia rolları ilə tag edər\n**/tektag <səbəb> - İstifadəçiləri tək tək tag edər\n**/admins <səbəb> - Yönəticiləri tək tək tag edər\n**/btag <səbəb> - Bayrağla tag edər**\n/stag <səbəb> - Şəhərlərimizin adları ilə tag edər"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('➕ Məni Qurupa əlavə et ➕', 'http://t.me/LacosteTaggerBot?startgroup=a')],
                      [Button.url('Dəstək Qurupu 👨‍💻', 'https://t.me/LacosteSup')],
                      [Button.url('Rəsmi Kanal 🔖', 'https://t.me/LacosteProject')],
                      [Button.url('Crazy Mmc', 'https://t.me/LacosteProject')],
		      [Button.url('Owner 👨🏻‍💻', 'https://t.me/Axhmedov')],
                    ),
                    link_preview=False
                   )
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Lacoste ', 'https://t.me/LacosteSup')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot aktifdi bot hakda məlumatı @Axhmedov dan ala bilərsən Versiya 1.7.5<<")
